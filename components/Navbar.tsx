...
export default function Navbar() {
  ...
  return (
    /* CORRECTION CRITIQUE : 
      On remplace "left-1/2 -translate-x-1/2" par "left-0 right-0 mx-auto".
      Le centrage est identique, mais SANS transform. Le bug du flou disparaît instantanément.
    */
    <nav className="fixed top-4 left-0 right-0 mx-auto w-[min(820px,92%)] z-[9999]">
      
      {/* Ici, on passe en pur Tailwind ultra-propre (similaire à ton bouton) :
        - bg-slate-950/40 : fond sombre mais très transparent (40%)
        - backdrop-blur-xl : active le flou profond des montagnes
        - saturate-180 : fait ressortir les couleurs violettes derrière
      */}
