              ...
              <div className="md:text-right">
                ...
                <div className="flex flex-wrap justify-start md:justify-end gap-3 w-full">
                  <MagneticButton 
                    ...
                    className="footer-glass-pill px-6 py-3 rounded-full text-foreground font-bold text-sm md:text-base flex items-center gap-2 group"
                  >
                  ...
                  <MagneticButton 
                    ...
                    className="footer-glass-pill px-6 py-3 rounded-full text-foreground font-bold text-sm md:text-base flex items-center gap-2 group"
                  >
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 22 22">
                    <title>Email</title>
