  ...
  return (
    <footer className="mt-20 border-t border-gray-800 pt-12 pb-6 bg-transparent">
      <div className="max-w-6xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-8 text-white">
        <div>
          <h3 className="text-2xl font-extrabold mb-3 font-playfair">Portfolio</h3>
        ...
        <div className="md:text-right">
          <h4 className="text-2xl font-extrabold mb-3 font-playfair">Suivez‑moi</h4>
          <div className="w-12 h-1 rounded-full bg-gradient-to-r from-purple-500 to-purple-600 mb-6 md:ml-auto" />

          <div className="flex gap-3 justify-start md:justify-end">
            <a href="https://github.com/johanfstr" target="_blank" aria-label="GitHub" className="w-10 h-10 rounded-lg border border-purple-700 flex items-center justify-center text-white/90 hover:bg-purple-400 hover:text-white rounded-full font-semibold shadow-lg transition-all transform hover:scale-115">
            ...
            <a href="https://www.linkedin.com/in/johanforestier/" target="_blank" aria-label="LinkedIn" className="w-10 h-10 rounded-lg border border-purple-700 flex items-center justify-center text-white/90 hover:bg-purple-400 hover:text-white rounded-full font-semibold shadow-lg transition-all transform hover:scale-115">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
            ...
            <a href="https://www.instagram.com/johanfstr" target="_blank" aria-label="Instagram" className="w-10 h-10 rounded-lg border border-purple-700 flex items-center justify-center text-white/90 hover:bg-purple-400 hover:text-white rounded-full font-semibold shadow-lg transition-all transform hover:scale-115">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
            ...
            <a href="mailto:contact@johanf.fr" aria-label="Mail" className="w-10 h-10 rounded-lg border border-purple-700 flex items-center justify-center text-white/90 hover:bg-purple-400 hover:text-white rounded-full font-semibold shadow-lg transition-all transform hover:scale-115">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                <title>Email</title>
